...
IR Sensor Module is placed beside the fifth car position of a road to detect the presence of car passed throught it. It will give a digital signal (HIGH or LOW) to determine the presence of car. 
